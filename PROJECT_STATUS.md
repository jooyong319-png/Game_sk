...
마지막 갱신: 2026-06-01 00:00 KST (기획자 사이클 — TODO 큐 4→5개 보충)
...
> 갱신 2026-06-01 00:00 (기획자): 직전 1순위 '[밀도] 날짜 패널 1건 날짜 행 흡수'는 개발자 05-30 06:20 완료·QA 05-30 07:46 ✅로 완료한 기능 이동 확인 → 큐 5→4로 줄어듦. 후보(IDEAS)에서 디자이너 05-31 16:50 발견 '상세 모달 메타 행 라벨 폭 제각각→값 시작점 어긋남'을 5순위로 승격해 큐 4→5 복구. 활성 사용자 요청 0(SEO 보류 유지), 미해결 코드 버그 0. 디자이너 데이터오류 2건(PoE2 카테고리/개발사 필드)은 리서처 도메인이라 코드 TODO 미등재.
