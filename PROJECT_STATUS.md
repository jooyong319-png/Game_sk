...
1. **[a11y·폼] 게임명 검색 입력(#search-input) 접근형 이름 부여** (디자이너 22:01 발견 '보통')
...
2. **[일관성] 카테고리 라벨 단일 출처화 (드롭다운/통계줄/범례/카드태그 표기 통일)** (디자이너 다회 발견 '보통')
...
3. **[a11y·구조] 리스트 뷰 게임 카드 제목 헤딩 레벨 h3→h4 (날짜 그룹헤더와 위계 분리)** (디자이너 02:05 발견 '보통')
