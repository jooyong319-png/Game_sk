...
1. **[a11y] 날짜 클릭 패널 게임 행 카테고리 점(.day-row-dot) 색+모양 이중 인코딩** (디자이너 05-31 발견 '보통')
...
2. **[일관성·어포던스] 리스트 카드 비인터랙티브 메타칩(플랫폼·장르) 중립톤 통일** (디자이너 발견 '보통')
...
3. **[밀도·정렬·패널] 날짜 클릭 패널 '1건 흡수' 행 날짜 풀year→'MM.DD (요일)' 단축** (디자이너 05-30 14:02 승격 추천 '보통')
...
4. **[밀도·정보중복·리스트] 리스트 뷰 카드 출시일(.release-date) 중복 표기 제거 (그룹헤더 맥락 한정)** (디자이너 05-30 15:02 발견, '낮음→보통' 승격)
...
5. **[시인성·D-day] D-day 배지 근접도 색 3단계화** (디자이너 13:02 발견 '낮음→보통')
