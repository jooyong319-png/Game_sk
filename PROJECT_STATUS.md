...
1. **[색일관] 캘린더 '오늘' 셀 라벨 색 amber→--accent(파랑) 통일** (디자이너 05-30 '낮음')
...
2. **[일관성·모달] 상세 모달 상단 배너 카테고리 텍스트 중복 제거** (디자이너 05-31 '보통')
...
3. **[a11y·모달] 상세 모달 닫기(×) 버튼 가시성 — 배너색 무관 고정 대비** (디자이너 12:50 '보통')
...
4. **[정렬·모달] 상세 모달 메타 행 라벨 폭 정렬 (값 좌측 컬럼 통일)** (디자이너 05-31 16:50 '보통')
...
5. **[UX·발견성] 활성 필터 '초기화' 컨트롤 추가** (디자이너 05-30 09:02 '보통')
