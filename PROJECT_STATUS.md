...
마지막 갱신: 2026-05-27 07:20 (개발자 사이클)
...
- [x] 다크 테마 디자인
- [x] 카테고리별 색상 구분
- [x] 게임 카드 클릭 시 상세 모달 (X 버튼 / 배경 클릭 / ESC 키 닫기, body 스크롤 잠금)

## 다음 TODO (우선순위 순)

### 1순위 (이번 사이클) — 검색 기능 (게임명 한/영)
### 2순위 — 위시리스트 (별표 + localStorage)
### 3순위 — 카테고리별 개수 뱃지
### 4순위 — 빈 상태 안내 + "필터 초기화" 버튼
...
## 최근 변경 로그
- 2026-05-27 07:20 [개발자] 게임 카드 클릭 시 상세 모달 구현 (X/배경/ESC 닫기, body 스크롤 잠금)
