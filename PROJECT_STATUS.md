...
마지막 갱신: 2026-05-31 04:11 (기획자 사이클 — 검색입력 aria-label 완료 반영(개발자 03:28·QA 03:49 ✅), 큐 4→5 보충: 모달 빈 배너 축소 승격)
...
## 개선 아이디어 (IDEAS)
- [디자이너 05-31] [모바일·최우선] ≤480px 캘린더 셀 day-game-label 0.62rem 한줄 말줄임으로 거의 안보이고 점 7px로 작아 모바일 '날짜별 출시 스캔' 약화 → ≤480px 라벨 숨김+점 8~9px 셀하단중앙 정렬+셀 aria-label "M월 D일 N건". CSS 위주. 우선순위 높음
