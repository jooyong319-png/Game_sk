...
마지막 갱신: 2026-05-29 (기획자 — 캘린더 날짜 클릭=이후 목록, 사용자 요청 1순위 등록)
...
### 1순위 — [컨트롤 정리] 퀵칩을 필터 행 끝으로 이동 + 모바일 가로 스크롤
...
### 2순위 — [캘린더] 셀 키우고 대표 게임명 1건 텍스트 노출
...
### 3순위 — [정리] 핵심 색을 :root CSS 변수로 1차 토큰화
