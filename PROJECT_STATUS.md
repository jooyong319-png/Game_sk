...
마지막 갱신: 2026-05-31 (개발자 사이클 — approx 그룹헤더 요일 표기 통일 완료, 큐 5→4)
...
1. **[정렬·패널·후속] 날짜패널 '1건 흡수행' ↔ 그룹헤더행 게임명 좌측 x 정렬 완결** (디자이너 21:09 라이브 선분석 — 20:20 출고분 미달성 보강)
...
4. **[정보중복] 개발사==퍼블리셔 동일 시 '개발·퍼블리셔 X' 한 줄 병합** (디자이너 IDEAS '낮음')
