...
1. **[밀도] 날짜 클릭 패널 — 1건 날짜는 날짜를 행 안으로 흡수** (디자이너 05-30 '보통')
...
2. **[스캔성] 출시 있는 셀에 옅은 면 강조** (디자이너 12:50/05-30 발견)
...
3. **[색일관] 캘린더 '오늘' 셀 라벨 색 amber→--accent(파랑) 통일** (디자이너 05-30 '낮음')
...
4. **[일관성·모달] 상세 모달 상단 배너 카테고리 텍스트 중복 제거** (디자이너 05-31 '보통')
...
5. **[a11y·모달] 상세 모달 닫기(×) 버튼 가시성 — 배너색 무관 고정 대비** (디자이너 12:50 '보통')
