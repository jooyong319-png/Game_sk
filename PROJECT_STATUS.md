...
## 개선 아이디어 (IDEAS)
- [디자이너 05-30] [a11y·폼] 게임명 검색 입력(#search-input)에 접근형 이름 부재 — placeholder만 있고 label·aria-label 없음(WCAG 4.1.2/3.3.2). select 3종은 label 래핑으로 이름 있으나 검색만 누락. #search-input에 aria-label="게임명 검색" 1줄. 우선순위 보통
