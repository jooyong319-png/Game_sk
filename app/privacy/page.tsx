  ...
  return (
    <PageShell>
      <article className="legal">
        ...
        <ul>
          <li><strong>댓글 작성 시</strong>: 닉네임, 댓글 내용. (이메일·실명 등 식별 정보는 수집하지 않습니다.)</li>
        ...
        <h2>5. 보유 및 파기</h2>
        <p>댓글은 작성자의 삭제 요청 또는 운영 정책에 따라 삭제될 때까지 보관됩니다. 삭제를 원하시면 아래 문의처로 연락 주시기 바랍니다.</p>

        <h2>6. 이용자의 권리</h2>
        <p>이용자는 본인이 작성한 댓글의 열람·삭제를 요청할 수 있습니다. 위시리스트·테마 등 로컬 저장 정보는 브라우저 설정에서 직접 삭제할 수 있습니다.</p>
