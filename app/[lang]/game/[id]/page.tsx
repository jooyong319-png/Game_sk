...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  const url = `https://gcalen.com/${params.lang}/game/${params.id}`;
  const koUrl = `https://gcalen.com/game/${params.id}`;
  ...
  return {
    ...
    alternates: {
      canonical: url,
      languages: { ko: koUrl, en: `https://gcalen.com/en/game/${params.id}`, ja: `https://gcalen.com/ja/game/${params.id}` },
    },
...
export default async function LocaleGamePage({ params }: Props) {
  ...
  const videoGameLd = {
    ...
    inLanguage: lang,
    url: `https://gcalen.com/${lang}/game/${params.id}`,
  };
